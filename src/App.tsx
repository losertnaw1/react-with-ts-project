...
function App() {
  ...
  return (
    <>
      <h1 className='mx-auto max-w-2xl lg:text-center text-3xl font-bold tracking-tight text-gray-900mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl'>DatLQ13's vegetable shop</h1>
